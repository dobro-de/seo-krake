...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `https://kiberatung.de/einzelhandel/${city.slug}` },
    openGraph: {
      title: city.metaTitle,
      description: city.metaDescription,
      url: `https://kiberatung.de/einzelhandel/${city.slug}`,
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          url: `https://kiberatung.de/einzelhandel/${slug}`,
