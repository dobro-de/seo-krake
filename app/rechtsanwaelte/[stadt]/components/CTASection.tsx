    ...
    >
      <div className="container" style={{ maxWidth: "700px", textAlign: "center" }}>
        ...
        <h2 className="section-heading section-heading-center" style={{ marginBottom: "20px" }}>
          Bereit, Ihre Kanzlei in {city.name} mit KI zu transformieren?
        </h2>
        ...
        >
          ...
          spezifische Situation im {city.name}er Rechtsmarkt und zeigen Ihnen konkrete
        ...
        >
          {[
            ...
            "Individuelle KI-Potenzialanalyse für Ihre Kanzlei",
