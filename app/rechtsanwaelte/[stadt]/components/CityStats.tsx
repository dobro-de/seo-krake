  ...
  const items = [
    {
      ...
      label: stats.label1,
      svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>,
    },
    {
      ...
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: "56px" }}>
          ...
          <h2 className="section-heading section-heading-center">
            Der Rechtsmarkt in {name} — Zahlen &amp; Fakten
          </h2>
