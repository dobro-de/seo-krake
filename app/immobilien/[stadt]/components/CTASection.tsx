    ...
    >
      <div className="container" style={{ maxWidth: "700px", textAlign: "center" }}>
        ...
        <h2 className="section-heading section-heading-center" style={{ marginBottom: "20px" }}>
          Bereit, Ihr Maklerbüro in {city.name} mit KI zu transformieren?
        </h2>
        ...
        >
          ...
          spezifische Situation im {city.name}er Immobilienmarkt und zeigen Ihnen konkrete
          KI-Potenziale mit realistischen ROI-Projektionen.
        </p>
        ...
        >
          {[
            ...
            "Individuelle KI-Potenzialanalyse für Ihr Maklerbüro",
